...
if (isset($_POST['submitbtn'])) {
    ...
    $email_sql = "SELECT * FROM $register WHERE email = '$u_signup_email'";
    ...
    if($numrows==0){
        if ($u_signup_password  == $u_signup_cpassword) {
            ...
            $sql = "INSERT IGNORE INTO $register (name,pass,email) VALUES('$u_signup_name','$u_signup_password','$u_signup_email')";
